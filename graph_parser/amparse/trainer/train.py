...
class AMTrainer(BaseTrainer):
    ...
    def train(self):
        ...
        if os.path.exists(self.config.model_name_or_path) and self.config.model_name_or_path != "PATH_to_longformer-base":
...
def main():
    ...
    if len(sys.argv) == 2 and sys.argv[1].endswith(".json"):
        ...
        config = parser.parse_args_into_dataclasses(return_remaining_strings=True)[0]
