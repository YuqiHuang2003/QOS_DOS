...
class AMParserConfig:
    ...
    postprocessor: Optional[str] = field(
        default="default:default,aaec:aaec,aaec_essay:aaec,aaec_para:aaec,mtc:mtc,cdcp:cdcp,abstrct:abstrct,aasd:aasd,tree:tree,trees:trees,graph:graph,ssa:ssa,mix:mix,synthetic:synthetic",
